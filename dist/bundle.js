...
var _todoReducers = __webpack_require__(70);
...
var store = (0, _redux.createStore)((0, _redux.combineReducers)({ todos: _todoReducers2.default }));
...
var todos = function todos() {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [{ id: 1, text: 'foo', completed: false }];
    var action = arguments[1];
    ...
    switch (action.type) {
        ...
        case 'ADD_TODO':
            return [].concat(_toConsumableArray(state), [{ id: action.id, completed: false, text: action.text }]);
        default:
            return state;
    }
};
